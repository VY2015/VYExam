...
Cid2GetPapers2Wnd::Cid2GetPapers2Wnd(void)
	: m_bIdChg(false)
{

}

//Cid2GetPapers2Wnd::Cid2GetPapers2Wnd( CLoginWnd *pParentWnd )
//{
//	m_pParentWnd = pParentWnd;
//}

LPCTSTR Cid2GetPapers2Wnd::GetWindowClassName() const
{ 
	return _T("UIChildLLogin"); 
}

UINT Cid2GetPapers2Wnd::GetClassStyle() const
{
	return UI_CLASSSTYLE_DIALOG; 
}

void Cid2GetPapers2Wnd::OnFinalMessage(HWND /*hWnd*/)
{ 
...
//{
//	Cid2GetPapers2Wnd *p = (Cid2GetPapers2Wnd*)dlg;
//
...
void Cid2GetPapers2Wnd::OnPrepare()
{
//	CComboUI *pComboUI1 = static_cast<CComboUI*>(m_pm.FindControl(_T("field")));
...
eSocketConnectStatus  Cid2GetPapers2Wnd::Connectd(CStringA Buffer)
{
	WSADATA  Ws;
	SOCKET CientSocket;
...
void Cid2GetPapers2Wnd::ConnectResultProc(eSocketConnectStatus eConnectStatus)
{
...
bool Cid2GetPapers2Wnd::GetIniFile()
{
...
void Cid2GetPapers2Wnd::onLoginBtnClicked()
{
	CString strBuf;
	CComboUI *pComboUI1 = static_cast<CComboUI*>(m_pm.FindControl(_T("field")));
	CComboUI *pComboUI2 = static_cast<CComboUI*>(m_pm.FindControl(_T("proj")));
...
void Cid2GetPapers2Wnd::Notify(TNotifyUI& msg)
{
	TRACE(L"%s\n\n",msg.sType);
...
LRESULT Cid2GetPapers2Wnd::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	CControlUI* pRoot = builder.Create(_T("id2GetPapers2.xml"), 0,NULL , &m_pm);
...
LRESULT Cid2GetPapers2Wnd::OnClose(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	bHandled = FALSE;
	return 0;
}

LRESULT Cid2GetPapers2Wnd::OnDestroy(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	//::PostQuitMessage(0L);
...
LRESULT Cid2GetPapers2Wnd::OnNcActivate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	if( ::IsIconic(*this) )
		bHandled = FALSE;
...
LRESULT Cid2GetPapers2Wnd::OnNcCalcSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	return 0;
}

LRESULT Cid2GetPapers2Wnd::OnNcPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	return 0;
}

LRESULT Cid2GetPapers2Wnd::OnNcHitTest(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	POINT pt; 
...
LRESULT Cid2GetPapers2Wnd::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT Cid2GetPapers2Wnd::OnGetMinMaxInfo(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT Cid2GetPapers2Wnd::OnSysCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT Cid2GetPapers2Wnd::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	LRESULT lRes = 0;
	BOOL bHandled = TRUE;
	switch( uMsg ) 
...
LRESULT Cid2GetPapers2Wnd::MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, bool& bHandled)
{
	if( uMsg == WM_KEYDOWN )
	{
		if( wParam == VK_RETURN )
