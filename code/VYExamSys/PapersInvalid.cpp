...
CPapersInvalidWnd::CPapersInvalidWnd(void)
	: m_bIdChg(false)
{

}

//CPapersInvalidWnd::CPapersInvalidWnd( CLoginWnd *pParentWnd )
//{
//	m_pParentWnd = pParentWnd;
//}

LPCTSTR CPapersInvalidWnd::GetWindowClassName() const
{ 
	return _T("UIChildLLogin"); 
}

UINT CPapersInvalidWnd::GetClassStyle() const
{
	return UI_CLASSSTYLE_DIALOG; 
}

void CPapersInvalidWnd::OnFinalMessage(HWND /*hWnd*/)
{ 
...
//{
//	CPapersInvalidWnd *p = (CPapersInvalidWnd*)dlg;
//
...
void CPapersInvalidWnd::OnPrepare()
{
//	CComboUI *pComboUI1 = static_cast<CComboUI*>(m_pm.FindControl(_T("field")));
...
eSocketConnectStatus  CPapersInvalidWnd::Connectd(CStringA Buffer)
{
	WSADATA  Ws;
	SOCKET CientSocket;
...
void CPapersInvalidWnd::ConnectResultProc(eSocketConnectStatus eConnectStatus)
{
...
bool CPapersInvalidWnd::GetIniFile()
{
...
void CPapersInvalidWnd::onLoginBtnClicked()
{
	CString strBuf;
	CComboUI *pComboUI1 = static_cast<CComboUI*>(m_pm.FindControl(_T("field")));
	CComboUI *pComboUI2 = static_cast<CComboUI*>(m_pm.FindControl(_T("proj")));
...
void CPapersInvalidWnd::Notify(TNotifyUI& msg)
{
	TRACE(L"%s\n\n",msg.sType);
...
LRESULT CPapersInvalidWnd::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	CControlUI* pRoot = builder.Create(_T("PapersInvaild.xml"), 0,NULL , &m_pm);
...
LRESULT CPapersInvalidWnd::OnClose(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	bHandled = FALSE;
	return 0;
}

LRESULT CPapersInvalidWnd::OnDestroy(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	//::PostQuitMessage(0L);
...
LRESULT CPapersInvalidWnd::OnNcActivate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	if( ::IsIconic(*this) )
		bHandled = FALSE;
...
LRESULT CPapersInvalidWnd::OnNcCalcSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	return 0;
}

LRESULT CPapersInvalidWnd::OnNcPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	return 0;
}

LRESULT CPapersInvalidWnd::OnNcHitTest(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	POINT pt; 
...
LRESULT CPapersInvalidWnd::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CPapersInvalidWnd::OnGetMinMaxInfo(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CPapersInvalidWnd::OnSysCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CPapersInvalidWnd::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	LRESULT lRes = 0;
	BOOL bHandled = TRUE;
	switch( uMsg ) 
...
LRESULT CPapersInvalidWnd::MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, bool& bHandled)
{
	if( uMsg == WM_KEYDOWN )
	{
		if( wParam == VK_RETURN )
