...
Cid2GetPapersWnd::Cid2GetPapersWnd(void)
	: m_bIdChg(false)
{

}

//Cid2GetPapersWnd::Cid2GetPapersWnd( CLoginWnd *pParentWnd )
//{
//	m_pParentWnd = pParentWnd;
//}

LPCTSTR Cid2GetPapersWnd::GetWindowClassName() const
{ 
	return _T("UIChildLLogin"); 
}

UINT Cid2GetPapersWnd::GetClassStyle() const
{
	return UI_CLASSSTYLE_DIALOG; 
}

void Cid2GetPapersWnd::OnFinalMessage(HWND /*hWnd*/)
{ 
...
//{
//	Cid2GetPapersWnd *p = (Cid2GetPapersWnd*)dlg;
//
...
void Cid2GetPapersWnd::OnPrepare()
{
//	CComboUI *pComboUI1 = static_cast<CComboUI*>(m_pm.FindControl(_T("field")));
...
eSocketConnectStatus  Cid2GetPapersWnd::Connectd(CStringA Buffer)
{
	WSADATA  Ws;
	SOCKET CientSocket;
...
void Cid2GetPapersWnd::ConnectResultProc(eSocketConnectStatus eConnectStatus)
{
...
bool Cid2GetPapersWnd::GetIniFile()
{
...
void Cid2GetPapersWnd::onLoginBtnClicked()
{
	CString strBuf;
	CComboUI *pComboUI1 = static_cast<CComboUI*>(m_pm.FindControl(_T("field")));
	CComboUI *pComboUI2 = static_cast<CComboUI*>(m_pm.FindControl(_T("proj")));
...
void Cid2GetPapersWnd::Notify(TNotifyUI& msg)
{
	TRACE(L"%s\n\n",msg.sType);
...
LRESULT Cid2GetPapersWnd::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	CControlUI* pRoot = builder.Create(_T("id2GetPapers.xml"), 0,NULL , &m_pm);
...
LRESULT Cid2GetPapersWnd::OnClose(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	bHandled = FALSE;
	return 0;
}

LRESULT Cid2GetPapersWnd::OnDestroy(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	//::PostQuitMessage(0L);
...
LRESULT Cid2GetPapersWnd::OnNcActivate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	if( ::IsIconic(*this) )
		bHandled = FALSE;
...
LRESULT Cid2GetPapersWnd::OnNcCalcSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	return 0;
}

LRESULT Cid2GetPapersWnd::OnNcPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	return 0;
}

LRESULT Cid2GetPapersWnd::OnNcHitTest(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	POINT pt; 
...
LRESULT Cid2GetPapersWnd::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT Cid2GetPapersWnd::OnGetMinMaxInfo(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT Cid2GetPapersWnd::OnSysCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT Cid2GetPapersWnd::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	LRESULT lRes = 0;
	BOOL bHandled = TRUE;
	switch( uMsg ) 
...
LRESULT Cid2GetPapersWnd::MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, bool& bHandled)
{
	if( uMsg == WM_KEYDOWN )
	{
		if( wParam == VK_RETURN )
